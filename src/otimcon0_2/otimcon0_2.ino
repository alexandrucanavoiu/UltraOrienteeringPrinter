...
static boolean printEscPos = true;        // used in mode PRINT, use EPSON ECS/POS format or not. Set to true if connected directly to POS printer, false if viewed on a serial monitor
